<section class="page-hero">
  <div class="page-hero-inner">
    ...
    <h1 class="page-hero-title">Hasil PPDB</h1>
    <p class="page-hero-text">
      Halaman pengumuman dibuat senada dengan halaman lain supaya alur informasi terasa konsisten.
    </p>
  </div>
</section>
...
<section class="page-content">
  <div class="section-card text-center">
    <div class="media-frame mb-4">
      <img src="<?= base_url('img/banner_area/bg.jpg') ?>" class="img-fluid" alt="Video profil sekolah">
    </div>

    <h2 class="section-title mb-2">Hasil Seleksi Telah Diumumkan</h2>
    <p class="section-subtitle mx-auto">
      Terima kasih telah mengikuti proses Penerimaan Peserta Didik Baru. Silakan hubungi panitia untuk mengetahui hasil dan informasi selanjutnya.
    </p>
    ...
    <div class="surface-card p-4 my-4 text-left">
      <div class="row">
        <div class="col-md-4 mb-3 mb-md-0">
          ...
          <p class="section-subtitle mb-0">08.00 - 15.00 WIB</p>
        </div>
        <div class="col-md-4 mb-3 mb-md-0">
          <div class="shortcut-icon mb-3"><i class="fas fa-bullhorn"></i></div>
          <h3 class="h5 font-weight-bold">Pengumuman</h3>
          <p class="section-subtitle mb-0">Silakan tanyakan langsung ke panitia melalui WhatsApp.</p>
        </div>
        <div class="col-md-4">
